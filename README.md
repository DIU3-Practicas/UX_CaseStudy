...
Gracias al mapa de empatía, hemos podido comprender en profundidad el comportamiento, las necesidades y los puntos de dolor de los usuarios. Como se detallará a continuación, este análisis ha contribuido al nacimiento de nuestro proyecto **Capital Burger Facelift**, cuya propuesta de valor tiene como principal propósito ofrecer la posibilidad de gestionar y organizar eventos privados (despedidas, cumpleaños, etc.) en los restaurantes a través de nuestra renovada plataforma. Asimismo, el proyecto busca solucionar problemas como la falta de información relevante (guía de valores nutricionales, alérgenos y contacto), y una estructura y diseño poco intuitivos que dificultan la navegación y comprensión de la página web.
